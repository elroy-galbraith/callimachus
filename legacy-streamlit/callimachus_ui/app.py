"""Callimachus — Streamlit landing page (legacy).
...
# ``from callimachus_ui.helpers import ...`` resolves whether Streamlit
...
from callimachus_ui.helpers import api_key_warning, get_active_project, project_chip

st.set_page_config(
    page_title="Callimachus",
    page_icon="🛠",
    layout="wide",
